...
describe('sequenceGenerator: ', function(){
	...
	describe("sequenceAllExtn", function() {
		it(" generates expected numbers", function() {
			var numbersArray = sequenceGenerator.sequenceAllExtn(17);
		...
		it(" generates expected number of numbers", function() {
			var numbersArray = sequenceGenerator.sequenceAllExtn(6);

			expect(numbersArray.length).toEqual(7);
		});

		it(" handles 0", function() {
			var numbersArray = sequenceGenerator.sequenceAllExtn(0);
		...
		it(" handles negative input", function() {
			var numbersArray = sequenceGenerator.sequenceAllExtn(-1);

			expect(numbersArray.length).toEqual(0);
		});

		it(" handles undefined input", function() {
			var numbersArray = sequenceGenerator.sequenceAllExtn();
