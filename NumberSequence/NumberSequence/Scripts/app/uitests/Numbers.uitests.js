describe('Numbers Page', function () {
    ...
    var expectNoSequences = function () {
        ...
        expect(numbersPage.sequenceAllExtn.getText()).toEqual('');
    ...
    it('should start with correct default', function () {
        ...
        expect(numbersPage.sequenceAllExtn.getText()).toEqual('Z, 1, 2, C, 4, E');
    ...
    it('should show correct values when digit added', function () {
        ...
        expect(numbersPage.sequenceAllExtn.getText()).toEqual('Z, 1, 2, C, 4, E, C, 7, 8, C, E, 11, C, 13, 14, Z, 16, 17, C, 19, E, C, 22, 23, C, E, 26, C, 28, 29, Z, 31, 32, C, 34, E, C, 37, 38, C, E, 41, C, 43, 44, Z, 46, 47, C, 49, E, C');
